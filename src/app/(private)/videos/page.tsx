                                    ...
                                    <div className={styles.scheduleMatches}>
                                      {schedule.rounds[0].matches.map((match) => (
                                        ...
                                        >
                                          ...
                                          <time>{getScheduleMatchTimeLabel(match.timeLabel) ?? t.timeTbc}</time>
                                        </div>
                                      ))}
                                    </div>
                                  </section>
