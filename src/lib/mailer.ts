...
export async function sendOtpEmail(input: {
  ...
  const text = `Tu código de verificación es ${input.code}. Caduca en ${input.expiresMinutes} minutos.`;
  ...
  <div style="font-family: 'Manrope', Arial, sans-serif; background:#f6f7f7; padding:32px;">
    <div style="max-width:520px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;">
      ...
      <h2 style="margin:0 0 8px;font-size:22px;color:#1a2c2a;">Tu código de acceso</h2>
      <p style="margin:0 0 16px;color:#4b4b4b;font-size:15px;">Usa este código para completar el acceso. Caduca en ${input.expiresMinutes} minutos.</p>
      ...
      <p style="margin:16px 0 0;color:#7a7f82;font-size:12px;">Si no has solicitado este código, puedes ignorar este email.</p>
      </div>
    </div>
  </div>
  `;
